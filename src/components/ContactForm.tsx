          ...
          <div className="sm:col-span-2">
            ...
            <div className="relative mt-2.5">
              ...
              <input
                ...
                id="phone-number"
                autoComplete="tel"
                className="block w-full rounded-md border-0 px-3.5 py-2 pl-20 text-gray-900 shadow-sm ring-1 ring-inset ring-white placeholder:text-white focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          <div className="sm:col-span-2">
              ...
              >
                ...
                <span
                  ...
                  className={classNames(
                    ...
                    'h-4 w-4 transform rounded-full bg-white shadow-sm ring-1 ring-orange-600 transition duration-200 ease-in-out',
                  )}
                />
              </Switch>
            </div>
